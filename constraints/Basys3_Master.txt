...
## LEDs - Remapped: L1->led[0], P1->led[1], N3->led[2], P3->led[3], ...
...
## Anodes for 7-segment display (active low)
## Display format: [P1 tens][P1 ones][P0 tens][P0 ones]
...
## Buttons
## btnC - Center button to Start/Stop game
